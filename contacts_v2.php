...
$page_name="contacts_v2.php";
if(CONTACTS_V2 != 1){redirect_to("404.php");}
...
<head>
    ...
    <title><?php echo SITE_NAME; ?> | Contacts 2</title>
			...
			while($row = mysqli_fetch_assoc($result))
				...
				<center>
						...
						if (file_exists($contact_url)) {
								echo '<img alt="image" class="img-circle" src="'.$contact_url.'">';
								}
								else
								{
                            ...
                            <h3 class="m-b-xs"><strong><?php echo $contact_name; ?></strong></h3>
                            <div class="font-bold"><?php echo $nick_name; ?></div></center>
                        ...
                        <div class="m-t-xs btn-group">
                            <a class="btn btn-xs btn-white" href="tel:<?php echo $mobile_number_1; ?>"><i class="fa fa-phone"></i> Call </a>
                            <a class="btn btn-xs btn-white" href="mailto:<?php echo $email_id_1; ?>"><i class="fa fa-envelope"></i> Email</a>
				...
				<div class="modal-dialog">
					<div class="modal-content animated flipInY">
						...
						<div class="modal-body">
							...
							<form role="form" method="post" action="contacts_v2.php">
